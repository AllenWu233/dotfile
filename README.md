...
You can use <code>config/i3/nord.sh</code> and <code>config/i3/cat.sh</code> to change the theme, and you can see details in [nord](https://www.nordtheme.com/) and [catppuccin](https://github.com/catppuccin).
